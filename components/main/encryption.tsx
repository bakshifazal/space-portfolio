...
export const Encryption = () => {
  return (
    <div className="flex flex-row relative items-center justify-center min-h-screen w-full h-full -z-20 px-4 sm:px-6 md:px-8">
      <div className="absolute w-auto h-auto top-10 sm:top-5 md:top-0 z-[5] px-4">
        <motion.div
      ...
      <div className="flex flex-col items-center justify-center translate-y-[-50px] absolute z-[20] w-auto h-auto">
        <div className="flex flex-col items-center group cursor-pointer w-auto h-auto">
          <Image
            ...
            width={50}
            height={50}
            className="translate-y-5 transition-all duration-200 group-hover:translate-y-11 w-[35px] h-[35px] sm:w-[45px] sm:h-[45px] md:w-[50px] md:h-[50px]"
          />
          <Image
            src="/lock-main.png"
            alt="Lock main"
